...
if __name__ == '__main__':
    ...
    if BUILD_ABTBUY:
        columns_to_preprocess = ['name', 'description', 'price']

        preprocess_magellan('../../../data/interim/abt-buy/abt-buy-train.json.gz', columns_to_preprocess,
                            experiment_name='abt-buy', dataset_name='abt-buy', validation_set='../../../data/interim/abt-buy/abt-buy-valid.csv')
        preprocess_magellan('../../../data/interim/abt-buy/abt-buy-gs.json.gz', columns_to_preprocess,
                            experiment_name='abt-buy', dataset_name='abt-buy')

    if BUILD_DI2KG:
        columns_to_preprocess = ['title', 'specs']

        preprocess_magellan('../../../data/interim/di2kg/monitor-train.json.gz', columns_to_preprocess,
                            experiment_name='monitor', dataset_name='di2kg',
                            validation_set='../../../data/interim/di2kg/monitor-valid.csv')
        preprocess_magellan('../../../data/interim/di2kg/monitor-gs.json.gz', columns_to_preprocess,
                            experiment_name='monitor', dataset_name='di2kg')

    if BUILD_DBLPSCHOLAR:
        columns_to_preprocess = ['title', 'authors', 'venue', 'year']

        preprocess_magellan('../../../data/interim/dblp-scholar/dblp-scholar-train.json.gz', columns_to_preprocess,
                            experiment_name='dblp-scholar', dataset_name='dblp-scholar',
                            validation_set='../../../data/interim/dblp-scholar/dblp-scholar-valid.csv')
        preprocess_magellan('../../../data/interim/dblp-scholar/dblp-scholar-gs.json.gz', columns_to_preprocess,
                            experiment_name='dblp-scholar', dataset_name='dblp-scholar')


    if BUILD_COMPANY:
        columns_to_preprocess = ['content']

        preprocess_magellan('../../../data/interim/company/company-train.json.gz', columns_to_preprocess,
                            experiment_name='company', dataset_name='company',
                            validation_set='../../../data/interim/company/company-valid.csv')
        preprocess_magellan('../../../data/interim/company/company-gs.json.gz', columns_to_preprocess,
                            experiment_name='company', dataset_name='company')